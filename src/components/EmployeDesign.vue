...
<div>
    <div class="container">
        ...
        <employesList :firstDizi="firstDizi" :secondDizi="secondDizi" />
...
<script>
import EmployesList from './EmployesList.vue'
export default {
    name: 'EmployeList',
    components: {
        EmployesList,
    ...
    methods: {
        Next() {
            if (this.first == 16 || this.second == 20) {
                this.first = 1
                this.firstDizi = this.first
                this.second = 5
                this.secondDizi = this.second
